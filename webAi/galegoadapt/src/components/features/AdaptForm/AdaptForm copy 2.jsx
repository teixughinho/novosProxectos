...
//       <label className="block space-y-1 text-xs font-medium text-slate-700 dark:text-slate-200">
//         <span>
//           Texto
//           <span className="ml-1 font-normal text-slate-500 dark:text-slate-400">
//             (opcional se subes un ficheiro)
...
//           value={text}
//           onChange={(e) => setText(e.target.value)}
//           placeholder="Pega ou escribe aquí o texto…"
//           className="w-full min-h-[160px] rounded-lg border border-slate-300 dark:border-slate-600 bg-slate-50 dark:bg-slate-950 p-3 text-sm text-slate-900 dark:text-slate-100 focus:border-sky-500 focus:ring-1 focus:ring-sky-500 outline-none transition"
//         />
//       </label>
...
//             file:text-xs file:font-semibold file:text-sky-700
//             hover:file:bg-sky-100
//             dark:file:bg-sky-900/40 dark:file:text-sky-200"
//         />
//         <p className="text-[11px] text-slate-500 dark:text-slate-400">
//           Se sobes un DOCX usarase automaticamente o seu contido.
//         </p>
//       </div>
//     </section>
...
//     <button
//       type="submit"
//       className="w-full rounded-xl bg-gradient-to-r from-sky-600 to-sky-500 px-5 py-3 text-sm font-semibold text-white shadow hover:from-sky-700 hover:to-sky-600 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-2 dark:focus:ring-offset-slate-900 transition"
//     >
//       ✨ Procesar contido
//     </button>
//   </form>
